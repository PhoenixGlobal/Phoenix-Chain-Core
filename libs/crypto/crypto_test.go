...
func TestSign(t *testing.T) {
	...
	addr := common.MustStringToAddress(testAddrString)
...
func TestNewContractAddress(t *testing.T) {
	...
	checkAddr(t, common.MustStringToAddress("0xxv7rxyyzfd7xs5fn72ldkt9yhz6d7ceac8r3c4"), caddr0)
	checkAddr(t, common.MustStringToAddress("0x30d8svcuj94qsjq59rjtqlyk6053d5t9wsgpsh"), caddr1)
	checkAddr(t, common.MustStringToAddress("0xe8w7maz3h33vaz9lj2f2lvfa7ddkwp5eyjeay2"), caddr2)
}
...
func TestLoadECDSAFile(t *testing.T) {
	...
	checkKey := func(k *ecdsa.PrivateKey) {
		checkAddr(t, PubkeyToAddress(k.PublicKey), common.MustStringToAddress(testAddrString))
