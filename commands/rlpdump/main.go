...
import (
	...
	"Phoenix-Chain-Core/pos/slashing"
...
var (
	errCode = flag.String("errCode", "", "dump given phoenixchain dpos tx receipt errCode description")
	inner   = flag.String("inner", "", "dump given phoenixchain inner contract data with `phoenixchain.Call`")
...
func main() {
	...
	// parse phoenixchain dpos tx receipt errCode
	...
	// parse phoenixchain inner contract data
	if *inner != "" {
