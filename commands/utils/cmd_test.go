...
func TestImportChain(t *testing.T) {
	/*
		...
		chain1, err := core.NewBlockChain(sdb, nil, params.TestChainConfig, pbft, vm.Config{}, nil)
		if err != nil {
		...
		blocks, _ := core.GenerateChain(params.TestChainConfig, types.NewBlockWithHeader(genesisBlock.Header()), pbft, sdb, 100, func(i int, b *core.BlockGen) {
		...
		chain2, err := core.NewBlockChain(chainDb, nil, params.TestChainConfig, pbft, vm.Config{}, nil)
		if err != nil {
