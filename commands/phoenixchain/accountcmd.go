...
between PhoenixChain nodes by simply copying.
...
`,
			},
			{
				...
				Description: `
    phoenixchain account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    phoenixchain account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    phoenixchain account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    phoenixchain account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another PhoenixChain instance,
...
func getPassPhrase(prompt string, confirmation bool, i int, passwords []string) string {
	...
	password, err := web.Stdin.PromptPassword("Passphrase: ")
	if err != nil {
