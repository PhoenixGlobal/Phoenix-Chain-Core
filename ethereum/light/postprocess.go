...
var (
	...
	DefaultServerIndexerConfig = &IndexerConfig{
		ChtSize:           configs.CHTFrequency,
		ChtConfirms:       configs.HelperTrieProcessConfirmations,
		BloomSize:         configs.BloomBitsBlocks,
		BloomConfirms:     configs.BloomConfirms,
		BloomTrieSize:     configs.BloomTrieFrequency,
		BloomTrieConfirms: configs.HelperTrieProcessConfirmations,
	}
	// DefaultClientIndexerConfig wraps a set of configs as a default indexer config for client side.
	DefaultClientIndexerConfig = &IndexerConfig{
		ChtSize:           configs.CHTFrequency,
		ChtConfirms:       configs.HelperTrieConfirmations,
		BloomSize:         configs.BloomBitsBlocksClient,
		BloomConfirms:     configs.HelperTrieConfirmations,
		BloomTrieSize:     configs.BloomTrieFrequency,
		BloomTrieConfirms: configs.HelperTrieConfirmations,
	}
