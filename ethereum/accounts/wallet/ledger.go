...
// Status implements wallet.driver, returning various states the Ledger can
// currently be in.
...
// Open implements wallet.driver, attempting to initialize the connection to the
...
// Close implements wallet.driver, cleaning up and metadata maintained within
// the Ledger driver.
...
// Heartbeat implements wallet.driver, performing a sanity check against the
...
// Derive implements wallet.driver, sending a derivation request to the Ledger
// and returning the Ethereum address located on that derivation path.
func (w *ledgerDriver) Derive(path accounts.DerivationPath) (common.Address, error) {
	return w.ledgerDerive(path)
}

// SignTx implements wallet.driver, sending the transaction to the Ledger and
