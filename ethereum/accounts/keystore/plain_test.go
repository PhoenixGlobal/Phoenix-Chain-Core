...
func tmpKeyStoreIface(t *testing.T, encrypted bool) (dir string, ks keyStore) {
	d, err := ioutil.TempDir("", "phoenixchain-keystore-test")
	if err != nil {
		t.Fatal(err)
	}
	if encrypted {
...
func TestImportPreSaleKey(t *testing.T) {
	...
	// with password "foo"
	fileContent := "{\"encseed\": \"26d87f5f2bf9835f9a47eefae571bc09f9107bb13d54ff12a4ec095d01f83897494cf34f7bed2ed34126ecba9db7b62de56c9d7cd136520a0427bfb11b8954ba7ac39b90d4650d3448e31185affcd74226a68f1e94b1108e6e0a4a91cdd83eba\", \"ethaddr\": \"0x63vykhmz9xmmayrj0v8u334erw6z0qslq30zf2\", \"email\": \"gustav.simonsson@gmail.com\", \"btcaddr\": \"1EVknXyFC68kKNLkh6YnKzW41svSRoaAcx\"}"
	pass := "foo"
	account, _, err := importPreSaleKey(ks, []byte(fileContent), pass)
	if err != nil {
		t.Fatal(err)
	}
	if account.Address != common.MustStringToAddress("0x63vykhmz9xmmayrj0v8u334erw6z0qslq30zf2") {
...
func TestV1_2(t *testing.T) {
	...
	addr := common.MustStringToAddress("0xedsat2wy39hmjevqjz6e0mcw00n00dn78xx5s5")
...
func TestKeyForDirectICAP(t *testing.T) {
	...
	if !strings.HasPrefix(key.Address.String(), "0x") {
