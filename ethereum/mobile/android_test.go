...
import org.ethereum.phoenixchain.*;
...
func TestAndroid(t *testing.T) {
	...
	workspace, err := ioutil.TempDir("", "phoenixchain-android-")
	if err != nil {
	...
	build.CopyFile(filepath.Join("libs", "phoenixchain.aar"), "phoenixchain.aar", os.ModePerm)
...
dependencies {
    ...
    compile(name: "phoenixchain", ext: "aar")
}
`
