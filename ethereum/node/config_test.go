...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "phoenixchain.ipc", false, filepath.Join(os.TempDir(), "phoenixchain.ipc")},
		{"data", "phoenixchain.ipc", false, "data/phoenixchain.ipc"},
		{"data", "./phoenixchain.ipc", false, "./phoenixchain.ipc"},
		{"data", "/phoenixchain.ipc", false, "/phoenixchain.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "phoenixchain.ipc", true, `\\.\pipe\phoenixchain.ipc`},
		{"data", "phoenixchain.ipc", true, `\\.\pipe\phoenixchain.ipc`},
		{"data", `\\.\pipe\phoenixchain.ipc`, true, `\\.\pipe\phoenixchain.ipc`},
	}
