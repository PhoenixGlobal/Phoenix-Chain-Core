...
import (
	...
	imath "github.com/PhoenixGlobal/Phoenix-Chain-Core/libs/common/math"
...
func NewHostModule() *wasm.Module {
	...
	// func $phoenixchain_gas_price(param $0 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_gas_price",
			Kind:     wasm.ExternalFunction,
		},
	)
	// void phoenixchain_block_hash(int64_t num, uint8_t hash[32])
	// func $phoenixchain_block_hash(param $0 i64) (param $1 i32)
	addFuncExport(m,
		wasm.FunctionSig{
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_block_hash",
			Kind:     wasm.ExternalFunction,
		},
	)

	// uint64_t phoenixchain_block_number()
	// func $phoenixchain_block_number (result i64)
	addFuncExport(m,
		wasm.FunctionSig{
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_block_number",
			Kind:     wasm.ExternalFunction,
		},
	)

	// uint64_t phoenixchain_gas_limit()
	// func $phoenixchain_gas_limit (result i64)
	addFuncExport(m,
		wasm.FunctionSig{
			ReturnTypes: []wasm.ValueType{wasm.ValueTypeI64},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_gas_limit",
			Kind:     wasm.ExternalFunction,
		},
	)
	// uint64_t phoenixchain_gas()
	// func $phoenixchain_gas (result i64)
	addFuncExport(m,
		wasm.FunctionSig{
			ReturnTypes: []wasm.ValueType{wasm.ValueTypeI64},
		},
	...
	addFuncExport(m,
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_timestamp",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_coinbase(uint8_t addr[20])
	// func $phoenixchain_coinbase (param $0 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_coinbase",
			Kind:     wasm.ExternalFunction,
		},
	)

	// uint8_t phoenixchain_balance(const uint8_t addr[20], uint8_t balance[16])
	// func $phoenixchain_balance (param $0 i32) (param $1 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_balance",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_origin(uint8_t addr[20])
	// func $phoenixchain_origin (param $0 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_origin",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_caller(uint8_t addr[20])
	// func $phoenixchain_caller (param $0 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_caller",
			Kind:     wasm.ExternalFunction,
		},
	)

	// uint8_t phoenixchain_call_value(uint8_t val[16])
	// func $phoenixchain_call_value (param $0 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes:  []wasm.ValueType{wasm.ValueTypeI32},
			ReturnTypes: []wasm.ValueType{wasm.ValueTypeI32},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_call_value",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_address(uint8_t addr[20])
	// func $phoenixchain_address  (param $0 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_address",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_sha3(const uint8_t *src, size_t srcLen, uint8_t *dest, size_t destLen)
	// func $phoenixchain_sha3  (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
	addFuncExport(m,
		wasm.FunctionSig{
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_sha3",
			Kind:     wasm.ExternalFunction,
		},
	)

	// uint64_t phoenixchain_caller_nonce()
	// func $phoenixchain_caller_nonce  (result i64)
	addFuncExport(m,
		wasm.FunctionSig{
			ReturnTypes: []wasm.ValueType{wasm.ValueTypeI64},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_caller_nonce",
			Kind:     wasm.ExternalFunction,
		},
	)

	// int32_t phoenixchain_transfer(const uint8_t to[20], const uint8_t *amount, size_t len)
	// func $phoenixchain_transfer  (param $1 i32) (param $2 i32) (param $3 i32) (result i64)
	addFuncExport(m,
		wasm.FunctionSig{
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_transfer",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_set_state(const uint8_t* key, size_t klen, const uint8_t *value, size_t vlen)
	// func $phoenixchain_set_state (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_set_state",
			Kind:     wasm.ExternalFunction,
		},
	)

	// size_t phoenixchain_get_state_length (const uint8_t* key, size_t klen)
	// func $phoenixchain_get_state_length (param $0 i32) (param $1 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes:  []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32},
			ReturnTypes: []wasm.ValueType{wasm.ValueTypeI32},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_get_state_length",
			Kind:     wasm.ExternalFunction,
		},
	)

	// int32_t phoenixchain_get_state(const uint8_t *key, size_t klen, uint8_t *value, size_t vlen)
	// func $phoenixchain_get_state (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes:  []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
			ReturnTypes: []wasm.ValueType{wasm.ValueTypeI32},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_get_state",
			Kind:     wasm.ExternalFunction,
		},
	)

	// size_t phoenixchain_get_input_length()
	// func $phoenixchain_get_input_length  (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ReturnTypes: []wasm.ValueType{wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_get_input_length",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_get_input(const uint8_t *value)
	// func $phoenixchain_get_input (param $0 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_get_input",
			Kind:     wasm.ExternalFunction,
		},
	)

	// size_t phoenixchain_get_call_output_length()
	// func $phoenixchain_get_call_output_length  (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ReturnTypes: []wasm.ValueType{wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_get_call_output_length",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_get_call_output(const uint8_t *value)
	// func $phoenixchain_get_call_output (param $0 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_get_call_output",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_return(const uint8_t *value, const size_t len)
	// func $phoenixchain_return(param $0 i32) (param $1 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_return",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_revert()
	// func $phoenixchain_return()
	addFuncExport(m,
		wasm.FunctionSig{},
		wasm.Function{
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_revert",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_panic()
	// func $phoenixchain_panic()
	addFuncExport(m,
		wasm.FunctionSig{},
		wasm.Function{
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_panic",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_debug(const uint8_t *dst, size_t len)
	// func $phoenixchain_debug (param i32 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32},
		},
	...
	// func $phoenixchain_call  (param $0 i32) (param $1 i32) (param $2 i32) (param $1 i32) (param $2 i32) (param $1 i32) (param $2 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
	...
	// func $phoenixchain_delegate_call (param $0 i32) (param $1 i32) (param $2 i32) (param $1 i32) (param $2 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_delegate_call",
			Kind:     wasm.ExternalFunction,
		},
	)
	...
	/*	// int32_t phoenixchain_static_call(const uint8_t to[20], const uint8_t* args, size_t argsLen, const uint8_t* callCost, size_t callCostLen);
		// func $phoenixchain_static_call (param $0 i32) (param $1 i32) (param $2 i32) (param $1 i32) (param $2 i32) (result i32)
		addFuncExport(m,
			wasm.FunctionSig{
				ParamTypes:  []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
				ReturnTypes: []wasm.ValueType{wasm.ValueTypeI32},
			...
			wasm.ExportEntry{
				FieldStr: "phoenixchain_static_call",
				Kind:     wasm.ExternalFunction,
			},
		)*/

	// int32_t phoenixchain_destroy(const uint8_t to[20])
	// func $phoenixchain_destroy (param $0 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes:  []wasm.ValueType{wasm.ValueTypeI32},
			ReturnTypes: []wasm.ValueType{wasm.ValueTypeI32},
	...
	// func $phoenixchain_migrate  (param $1 i32) (param $2 i32) (param $0 i32) (param $1 i32) (param $2 i32) (param $1 i32) (param $2 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32,
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_migrate",
			Kind:     wasm.ExternalFunction,
		},
	)

	// int32_t phoenixchain_clone_migrate(const uint8_t old_addr[20], uint8_t newAddr[20], const uint8_t* args, size_t argsLen, const uint8_t* value, size_t valueLen, const uint8_t* callCost, size_t callCostLen);
	// func $phoenixchain_clone_migrate (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32) (param $6 i32) (param $7 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32,
				wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_clone_migrate",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_event(const uint8_t *topic, size_t topic_len, const uint8_t *args, size_t args_len);
	// func $phoenixchain_event (param $0 i32) (param $1 i32) (param $0 i32) (param $1 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_event",
			Kind:     wasm.ExternalFunction,
		},
	)

	// int32_t phoenixchain_ecrecover(const uint8_t hash[32], const uint8_t* sig, const uint8_t sig_len, uint8_t addr[20])
	// func phoenixchain_ecrecover (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes:  []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
			ReturnTypes: []wasm.ValueType{wasm.ValueTypeI32},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_ecrecover",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_ripemd160(const uint8_t *input, uint32_t input_len, uint8_t hash[20])
	// func phoenixchain_ripemd160 (param $0 i32) (param $1 i32) (param $2 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_ripemd160",
			Kind:     wasm.ExternalFunction,
		},
	)

	// void phoenixchain_sha256(const uint8_t *input, uint32_t input_len, uint8_t hash[32])
	// func phoenixchain_sha256 (param $0 i32) (param $1 i32) (param $2 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
		},
	...
	// func phoenixchain_rlp_u128 (param $0 i64) (param $1 i64) (param $2 i32)
	addFuncExport(m,
		wasm.FunctionSig{
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_rlp_u128",
			Kind:     wasm.ExternalFunction,
		},
	)
	...
	// func phoenixchain_rlp_bytes (param $0 i32) (param $1 i32) (param $2 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_rlp_bytes",
			Kind:     wasm.ExternalFunction,
		},
	)
	...
	// func phoenixchain_rlp_list (param $0 i32) (param $1 i32) (param $2 i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
		},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_rlp_list",
			Kind:     wasm.ExternalFunction,
		},
	)

	// size_t phoenixchain_contract_code_length(const uint8_t addr[20]);
	// func phoenixchain_contract_code_length (param $0 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes:  []wasm.ValueType{wasm.ValueTypeI32},
			ReturnTypes: []wasm.ValueType{wasm.ValueTypeI32},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_contract_code_length",
			Kind:     wasm.ExternalFunction,
		},
	)

	// int32_t phoenixchain_contract_code(const uint8_t addr[20], uint8_t *code, size_t code_length);
	// func phoenixchain_contract_code (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes:  []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
			ReturnTypes: []wasm.ValueType{wasm.ValueTypeI32},
		...
		wasm.ExportEntry{
			FieldStr: "phoenixchain_contract_code",
			Kind:     wasm.ExternalFunction,
		},
	)

	// int32_t phoenixchain_deploy(uint8_t newAddr[20], const uint8_t* args, size_t argsLen, const uint8_t* value, size_t valueLen, const uint8_t* callCost, size_t callCostLen);
	// func $phoenixchain_deploy (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32) (param $6 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32,
				wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
		...
		wasm.Function{
			Host: reflect.ValueOf(PhoenixchainDeploy),
			Body: &wasm.FunctionBody{},
		},
		wasm.ExportEntry{
			FieldStr: "phoenixchain_deploy",
			Kind:     wasm.ExternalFunction,
		},
	)

	// int32_t phoenixchain_clone(const uint8_t old_addr[20], uint8_t newAddr[20], const uint8_t* args, size_t argsLen, const uint8_t* value, size_t valueLen, const uint8_t* callCost, size_t callCostLen);
	// func $phoenixchain_clone (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32) (param $6 i32) (param $7 i32) (result i32)
	addFuncExport(m,
		wasm.FunctionSig{
			ParamTypes: []wasm.ValueType{wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32,
				wasm.ValueTypeI32, wasm.ValueTypeI32, wasm.ValueTypeI32},
		...
		wasm.Function{
			Host: reflect.ValueOf(PhoenixchainClone),
			Body: &wasm.FunctionBody{},
		},
		wasm.ExportEntry{
			FieldStr: "phoenixchain_clone",
			Kind:     wasm.ExternalFunction,
		},
	)
...
func Caller(proc *exec.Process, dst uint32) {
	...
	if currentValue >= configs.FORKVERSION_1_1_0 {
...
func Sha3(proc *exec.Process, src uint32, srcLen uint32, dst uint32, dstLen uint32) {
	...
	if wordGas, overflow = imath.SafeMul(toWordSize(uint64(srcLen)), configs.Sha3WordGas); overflow {
		panic(errGasUintOverflow)
	}
	if gas, overflow = imath.SafeAdd(wordGas, configs.Sha3Gas); overflow {
		panic(errGasUintOverflow)
	}
...
func Transfer(proc *exec.Process, dst uint32, amount uint32, len uint32) int32 {
	...
	gasTemp, err := callGas(ctx.contract.Gas, configs.TxGas, uint256.NewInt().SetUint64(ctx.contract.Gas))
	if nil != err {
		panic(err)
	}
	...
	if transfersValue {
		if gas, overflow = imath.SafeAdd(gas, configs.CallStipend); overflow {
			panic(errGasUintOverflow)
		}
	}
...
func SetState(proc *exec.Process, key uint32, keyLen uint32, val uint32, valLen uint32) {
	...
	case 0 == len(currentValue) && 0 != valLen:
		checkGas(ctx, newWordSize*configs.SstoreSetGas)
	case 0 != len(currentValue) && 0 == valLen:
		ctx.evm.StateDB.AddRefund(oldWordSize * configs.SstoreRefundGas)
		checkGas(ctx, oldWordSize*configs.SstoreClearGas)
	default:
		var (
		...
		checkGas(ctx, addWordSize*configs.SstoreSetGas)
		ctx.evm.StateDB.AddRefund(deleteWordSize * configs.SstoreRefundGas)
		checkGas(ctx, deleteWordSize*configs.SstoreClearGas)
		checkGas(ctx, resetWordSize*configs.SstoreResetGas)
	}
...
func ReturnContract(proc *exec.Process, dst uint32, len uint32) {
	...
	if gas, overflow = imath.SafeMul(configs.MemoryGas, uint64(len)); overflow {
		panic(errGasUintOverflow)
	}
...
func DestroyContract(proc *exec.Process, addrPtr uint32) int32 {
	...
	if !ctx.evm.StateDB.HasSuicided(ctx.contract.Address()) {
		ctx.evm.StateDB.AddRefund(configs.SuicideRefundGas)
	}
	checkGas(ctx, gas)
...
func MigrateInnerContract(proc *exec.Process, newAddr, val, valLen, callCost, callCostLen uint32, input []byte) int32 {
	...
	// check call depth
	if ctx.evm.depth > int(configs.CallCreateDepth) {
		return -1
	}
	...
	if err == nil && !maxCodeSizeExceeded {
		createDataGas := uint64(len(ret)) * configs.CreateWasmDataGas
...
func Ecrecover(proc *exec.Process, hashPtr, sigPtr, sigLen, addrPtr uint32) int32 {
	...
	checkGas(ctx, configs.EcrecoverGas)
	hash := make([]byte, 32)
...
func Ripemd160(proc *exec.Process, inputPtr, inputLen uint32, outputPtr uint32) {
	...
	if gas, overflow = imath.SafeMul(toWordSize(uint64(inputLen)), configs.Ripemd160PerWordGas); overflow {
		panic(errGasUintOverflow)
	}
	if gas, overflow = imath.SafeAdd(gas, configs.Ripemd160BaseGas); overflow {
		panic(errGasUintOverflow)
	}
	checkGas(ctx, gas)
...
func Sha256(proc *exec.Process, inputPtr, inputLen uint32, outputPtr uint32) {
	...
	if gas, overflow = imath.SafeMul(toWordSize(uint64(inputLen)), configs.Sha256PerWordGas); overflow {
		panic(errGasUintOverflow)
	}
	if gas, overflow = imath.SafeAdd(gas, configs.Sha256BaseGas); overflow {
		panic(errGasUintOverflow)
	}
	checkGas(ctx, gas)
...
func logGas(topicNum, dataSize uint64) (uint64, error) {
	gas := configs.LogGas
	var overflow bool
	if gas, overflow = imath.SafeAdd(gas, topicNum*configs.LogTopicGas); overflow {
		return 0, errGasUintOverflow
	}

	var logSizeGas uint64
	if logSizeGas, overflow = imath.SafeMul(dataSize, configs.LogDataGas); overflow {
		return 0, errGasUintOverflow
	}
...
func RlpU128(proc *exec.Process, heigh uint64, low uint64, dest uint32) {
	...
	// Cost of gas
	if gas, overflow = imath.SafeMul(configs.MemoryGas, uint64(len(data))); overflow {
		panic(errGasUintOverflow)
	}
	if gas, overflow = imath.SafeAdd(gas, GasQuickStep); overflow {
		panic(errGasUintOverflow)
...
func RlpBytes(proc *exec.Process, src uint32, length uint32, dest uint32) {
	...
	if gas, overflow = imath.SafeMul(configs.MemoryGas, uint64(len(prefixData)+len(data))); overflow {
		panic(errGasUintOverflow)
	}
	if gas, overflow = imath.SafeAdd(gas, GasQuickStep); overflow {
		panic(errGasUintOverflow)
...
// int32_t phoenixchain_deploy(uint8_t newAddr[20], const uint8_t* args, size_t argsLen, const uint8_t* value, size_t valueLen, const uint8_t* callCost, size_t callCostLen);
func PhoenixchainDeploy(proc *exec.Process, newAddr, args, argsLen, val, valLen, callCost, callCostLen uint32) int32 {
	// Cost of gas
	ctx := proc.HostCtx().(*VMContext)
	checkGas(ctx, ctx.gasTable.SLoad)
...
// int32_t phoenixchain_clone(const uint8_t old_addr[20], uint8_t newAddr[20], const uint8_t* args, size_t argsLen, const uint8_t* value, size_t valueLen, const uint8_t* callCost, size_t callCostLen);
func PhoenixchainClone(proc *exec.Process, oldAddr, newAddr, args, argsLen, val, valLen, callCost, callCostLen uint32) int32 {
	// Cost of gas
	ctx := proc.HostCtx().(*VMContext)
	checkGas(ctx, ctx.gasTable.SLoad)
