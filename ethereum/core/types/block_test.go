...
func TestBlockEncoding(t *testing.T) {
	...
	check("Coinbase", block.Coinbase(), common.MustStringToAddress("0x3zy0ruv447se9nlwscrfskzvqv85e8d35gau40"))
	...
	tx1 := NewTransaction(0, common.MustStringToAddress("0xp908ht4x5mrufsklawtha7kry6h42tv8sxxrdc"), big.NewInt(10), 50000, big.NewInt(10), nil)
