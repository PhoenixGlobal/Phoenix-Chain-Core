...
func (s *StateSuite) TestNull(c *checker.C) {
	address := common.MustStringToAddress("0xqqqqqqyzx9q8zzl38xgwg5qpxeexmz64ex89tk")
...
func TestForEachStorage(t *testing.T) {
	tmpDir, _ := ioutil.TempDir("", "phoenixchain")
...
func TestMigrateStorage(t *testing.T) {
	...
	from := common.MustStringToAddress("0xqqqqqqyzx9q8zzl38xgwg5qpxeexmz64ex89tk")
	state.CreateAccount(from)

	to := common.MustStringToAddress("0xqqqqqqrjxpq8zzl38xgwg5qpxeex6mnxwyzlxv")
