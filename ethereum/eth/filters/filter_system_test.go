...
func (b *testBackend) GetReceipts(ctx context.Context, hash common.Hash) (types.Receipts, error) {
	if number := rawdb.ReadHeaderNumber(b.db, hash); number != nil {
		return rawdb.ReadReceipts(b.db, hash, *number, configs.TestChainConfig), nil
	}
	return nil, nil
}
...
func (b *testBackend) GetLogs(ctx context.Context, hash common.Hash) ([][]*types.Log, error) {
	...
	receipts := rawdb.ReadReceipts(b.db, hash, *number, configs.TestChainConfig)
...
func TestBlockSubscription(t *testing.T) {
	...
	var (
		...
		//chain, _    = core.GenerateChain(params.TestChainConfig, genesis, pbft.New(params.GrapeChainConfig.Pbft, nil, nil, ctx), db, 10, func(i int, gen *core.BlockGen) {})
		chain, _    = core.GenerateChain(configs.TestChainConfig, genesis, consensus.NewFaker(), db, 10, func(i int, gen *core.BlockGen) {})
...
func TestPendingTxFilter(t *testing.T) {
	...
	var (
		...
		transactions = []*types.Transaction{
			types.NewTransaction(0, common.MustStringToAddress("0xk720t6st5w2ffn5r5gfll7a8gfu40yngyvr9yv"), new(big.Int), 0, new(big.Int), nil),
			types.NewTransaction(1, common.MustStringToAddress("0xk720t6st5w2ffn5r5gfll7a8gfu40yngyvr9yv"), new(big.Int), 0, new(big.Int), nil),
			types.NewTransaction(2, common.MustStringToAddress("0xk720t6st5w2ffn5r5gfll7a8gfu40yngyvr9yv"), new(big.Int), 0, new(big.Int), nil),
			types.NewTransaction(3, common.MustStringToAddress("0xk720t6st5w2ffn5r5gfll7a8gfu40yngyvr9yv"), new(big.Int), 0, new(big.Int), nil),
			types.NewTransaction(4, common.MustStringToAddress("0xk720t6st5w2ffn5r5gfll7a8gfu40yngyvr9yv"), new(big.Int), 0, new(big.Int), nil),
		}
...
func TestLogFilter(t *testing.T) {
	...
	var (
		...
		firstAddr      = common.MustStringToAddress("0xzyg3zyg3zyg3zyg3zyg3zyg3zyg3zyg3fw0wpq")
		secondAddr     = common.MustStringToAddress("0xyg3zyg3zyg3zyg3zyg3zyg3zyg3zyg3zxn2gfh")
		thirdAddress   = common.MustStringToAddress("0xxvenxvenxvenxvenxvenxvenxvenxven5da4u9")
		notUsedAddress = common.MustStringToAddress("0xnxvenxvenxvenxvenxvenxvenxvenxve6sx7qy")
