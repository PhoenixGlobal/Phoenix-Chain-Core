...
var (
	...
	unknownBlock = types.NewBlock(&types.Header{GasLimit: configs.GenesisGasLimit}, nil, nil)
)
...
func makeChain(n int, seed byte, parent *types.Block) ([]common.Hash, map[common.Hash]*types.Block) {
	...
	//
	//blocks, _ := core.GenerateChain(params.TestChainConfig, parent, pbft.New(params.GrapeChainConfig.Pbft, nil, nil, ctx), testdb, n, func(i int, block *core.BlockGen) {
	blocks, _ := core.GenerateChain(configs.TestChainConfig, parent, consensus.NewFaker(), testdb, n, func(i int, block *core.BlockGen) {
