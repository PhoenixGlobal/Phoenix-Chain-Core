...
var (
	...
	maxForkAncestry   uint64 = configs.ImmutabilityThreshold // Maximum chain reorganisation (locally redeclared so tests can reduce it)
...
//if  the user close phoenixchain when sync not finish,set status fail
