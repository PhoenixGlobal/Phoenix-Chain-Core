...
var (
	...
	skipPrefixes = []string{
		...
		"commands/internal/browser",
		"consensus/ethash/xor.go",
		"libs/crypto/bn256/",
		"libs/crypto/ecies/",
		"libs/crypto/secp256k1/curve.go",
		"libs/crypto/sha3/",
		"internal/jsre/deps",
		"libs/log/",
		"libs/common/bitutil/bitutil",
		// don't license generated files
		"internal/contracts/chequebook/contract/code.go",
	}

	// paths with this prefix are licensed as GPL. all other files are LGPL.
	gplPrefixes = []string{"commands/"}
	...
	authorsFileHeader = "# This is the official list of Phoenix-Chain-Core authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The Phoenix-Chain-Core Authors
